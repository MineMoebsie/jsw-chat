...
<div class="w-full p-2">
  <div class="flex rounded-lg shadow-xl">
    <form class="grow flex" on:submit|preventDefault={send}>
      <input placeholder="Message…" class="p-2 w-full rounded-l-lg border-blue-800 border-2
      dark:bg-slate-700 dark:text-white outline-none 
      focus:border-r-0 focus:border-blue-500 focus:border-solid peer sm:focus:border-l-2 sm:rounded-l-lg" bind:value={value} on:submit={send}/>
